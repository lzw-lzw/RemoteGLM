...
DESCRIPTION = '''# <a href="https://github.com/lzw-lzw/RemoteGLM">RemoteGLM</a>'''
...
NOTES = 'This app is adapted from <a href="https://github.com/lzw-lzw/RemoteGLM">https://github.com/lzw-lzw/RemoteGLM</a>. It would be recommended to check out the repo if you want to see the detail of our model and training process.'
